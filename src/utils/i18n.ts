...
const resources = {
  en: {
    translation: {
      ...
      volumeM3: "Volume (m^3)",
      plateNo: "Plate no.",
      maxPriceM3: "Max price / m^3 (EUR)",
      maxPrice: "Max offered price",
      minPrice: "Min price",
      minPriceM3: "Min price / m^3 (EUR)",
      ...
      offeredPriceM3: "Offered price / m^3 (EUR)",
      inventory: "Inventory",
      save: "Save",
      ...
      costsTo350:
        "Auction costs for wood pieces valued up to 350 EUR / m^3 (22 EUR / m^3)",
      costsAbove350:
        "Auction costs for wood pieces valued above 350 EUR / m^3 (5% total)",
      ...
      transportCosts: "Transport costs (18 EUR / m^3)",
      transportVAT: "Transport VAT (22%)",
      loggingCosts: "Logging costs (100 EUR / m^3)",
  ...
  sl: {
    translation: {
      ...
      widthCm: "Debelina (cm)",
      lengthM: "Dolzina (m)",
      volumeM3: "Kubatura (m^3)",
      plateNo: "St. ploscice",
      maxPriceM3: "Ponujena cena / m^3 (EUR)",
      maxPrice: "Ponujena cena",
      minPrice: "Pricakovana cena",
      minPriceM3: "Pricakovana cena / m^3 (EUR)",
      ...
      offeredPriceM3: "Ponujena cena / m^3 (EUR)",
      inventory: "Inventar",
      save: "Shrani",
      ...
      costsTo350:
        "Stroski licitacije za vrednost hlodov do 350 EUR / m^3 (22 EUR / m^3)",
      costsAbove350:
        "Stroski licitacije za vrednost hlodov nad 350 EUR / m^3 (5% vrednosti)",
      ...
      transportCosts: "Strosek prevoza (18 EUR / m^3)",
      ...
      loggingCosts: "Posek gozdni (100 EUR / m^3)",
