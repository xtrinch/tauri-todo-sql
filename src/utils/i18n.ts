...
const resources = {
  en: {
    translation: {
      ...
      boughtWoodPiecesPreview: "Preview of bought wood pieces",
      ...
      invoicePreviewPDFName: "invoice-preview",
      ...
      minPriceReached: "Min price reached",
      noData: "No data",
      ...
      invoicePreviewNotice:
        "This preview includes the highest offers even when the expected minimum price was not reached.",
      invoice: "Invoice",
      ...
      exportOfferStatistics: "Export offer statistics",
      exportStatisticsForBuyers: "Export statistics for buyers",
      exportTreeSpecies: "Export tree species",
      statisticsPDFName: "statistics",
      offerStatisticsPDFName: "offer-statistics",
      statisticsForBuyersPDFName: "statistics-for-buyers",
      treeSpeciesPDFName: "tree-species",
      ...
      topPiecesTitle: "Top pieces per species",
      topPiecesLimit: "Top N",
      topPiecesMeasure: "Measure",
      topPiecesMeasureThickness: "Thickness",
      topPiecesMeasureVolume: "Cubature",
    },
  },
  sl: {
    translation: {
      ...
      exportPreview: "Izvozi predogled",
      soldPiecesPDFName: "prodani-kosi",
      invoicePreviewPDFName: "predogled-obracuna",
      ...
      minPriceReached: "Dosežena pričakovana cena",
      noData: "Ni podatkov",
      ...
      invoicePreview: "Predogled obračuna",
      invoicePreviewNotice:
        "Ta predogled vključuje najvišje ponudbe tudi za hlode, kjer pričakovana cena ni dosežena.",
      invoice: "Obračun",
      resetApplicationData: "Resetiraj podatke aplikacije",
      language: "Jezik",
      languageSl: "Slovenščina",
      languageEn: "Angleščina",
      ...
      exportOfferStatistics: "Izvozi statistiko ponudb",
      exportStatisticsForBuyers: "Izvozi statistiko za kupce",
      exportTreeSpecies: "Izvozi drevesne vrste",
      statisticsPDFName: "statistika",
      offerStatisticsPDFName: "statistika-ponudb",
      statisticsForBuyersPDFName: "statistika-za-kupce",
      treeSpeciesPDFName: "drevesne-vrste",
      preparingUpdate: "Pripravljam posodobitve...",
      settings: "Nastavitve",
      images: "Slike",
      headerImage: "Naslovna slika",
      woodImage: "Slika lesa",
      replaceImage: "Zamenjaj sliko",
      imageUpdated: "Slika posodobljena",
      unsupportedImageType: "Nepodprta vrsta slike",
      ...
      offerStatistics: "Statistika ponudb",
      topPiecesTitle: "Najboljši hlodi po drevesni vrsti",
      topPiecesLimit: "Število (N)",
      topPiecesMeasure: "Merilo",
      topPiecesMeasureThickness: "Debelina",
      topPiecesMeasureVolume: "Kubatura",
    },
  },
};
